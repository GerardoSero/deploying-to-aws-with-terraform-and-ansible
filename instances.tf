...
ansible-playbook --extra-vars 'passed_in_hosts=tag_Name_${self.tags.Name} master_ip=${aws_instance.jenkins-main.private_ip}' ansible_templates/install_jenkins_worker.yaml
EOF
  }
  ...
  #   when = destroy
  #   inline = [
  #     "java -jar /home/ec2-user/jenkins_cli.jar -auth @/home/ec2-user/jenkins_auth -s https://${aws_instance.jenkins-main.private_ip}:8080 delete-node ${self.private_ip}"
  #   ]
  #   connection {
  #     type        = "ssh"
  #     user        = "ec2-user"
